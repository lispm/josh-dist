...
(define-predicate-model cf-mixin 
    ((certainty-factor :initform 0 :accessor certainty-factor :initarg :certainty-factor)
     (justifications :initform nil :accessor justifications :initarg :justifications)
     (out-going-justs :initform nil :accessor outgoing-justs :initarg :outgoing-justs))
  ())

(defmethod init-plist append ((p cf-mixin))
  (list :certainty-factor (certainty-factor p)
	:justifications (justifications p)
	:outgoing-justs (outgoing-justs p)))
